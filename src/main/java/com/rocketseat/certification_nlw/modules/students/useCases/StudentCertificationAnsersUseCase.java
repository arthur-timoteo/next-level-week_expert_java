...
@Service
public class StudentCertificationAnsersUseCase {
    ...
    @Autowired
    private VerifiIfHasCertificationUseCase verifyIfHasCertificationUseCase;

    public CertificationStudentEntity execute(StudentCertificationAnswerDTO dto) throws Exception {

        var hasCertification = this.verifyIfHasCertificationUseCase.execute(new VerifiIfHasCertificationDTO(dto.getEmail(), dto.getTechnology()));
        ...
        // Verificar se existe o student pelo email
